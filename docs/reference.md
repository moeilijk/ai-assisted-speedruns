...
2. Upload the video from the private run directory, not from the public folder: `<run>/recording/UPLOAD.txt`
   ...
   line first, and the chapters. Put the line in the field a viewer can read on that platform: the description, or
