...
1. `aas publish <run-dir> <out-dir>` writes the bundle and the upload sheet, and prints the code
   `aas<16 hex>`, the same for every video of the bundle.
