...
export default {
  ...
  setup: {
    folder: "BizHawk",
    settings: [
      { env: "AAS_BIZHAWK_DIR", label: "BizHawk folder", kind: "dir", expect: "EmuHawk.exe", what: "Where BizHawk is: the folder with EmuHawk.exe in it. The install puts it in %LOCALAPPDATA%\\aas\\BizHawk." },
