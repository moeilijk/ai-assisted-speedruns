...
Publishing the same run again, after `aas resume` or when the tooling changes the bundle, is a new revision: what to do again, and which video descriptions need the new line, is in [docs/reference.md](docs/reference.md#a-new-revision).
