...
test("Claude Code session export: messages, tool calls, results; host text, thinking, images and ids removed", async () => {
  ...
  const rows = [
    ...
    { type: "assistant", timestamp: "2026-09-09T10:01:00.000Z", requestId: "req_2", message: { role: "assistant", model: "claude-fable-5-1", content: [{ type: "text", text: "Reached the end credits." }], usage: { input_tokens: 1, output_tokens: 2 } } },
  ];
